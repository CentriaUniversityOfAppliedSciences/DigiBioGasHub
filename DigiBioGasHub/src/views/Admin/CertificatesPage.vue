<template>
    <ion-page>
        <ion-content>
            ...
            <ion-grid>
                ...
                <ion-row >
                    <ion-col size="3" v-for="certificate in certificates">
                        <CertificatesComponent v-if="certificate" :certificate="certificate" @update="updateCertificates" :isAdmin="true" />
                    </ion-col>
                </ion-row>
            ...
            <AddCertificateComponent @update="updateCertificates" :isAdmin="true" />
        </ion-content>
        <FooterComponent />
    </ion-page>
</template>
