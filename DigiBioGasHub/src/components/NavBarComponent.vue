    ...
    <nav class="navbar">
        ...
        <div class="navbar-right">
            ...
            <ul class="menu" v-if="!isMobile">
                ...
                <li v-if="LoggedIn && inCompany" class="menu-item"><a href="/contracts">{{ $t('menu.mycontracts') }}</a></li>
                <li v-if="LoggedIn" class="menu-item"><a href="/company">{{ $t('menu.mycompany') }}</a></li>
                <li v-if="LoggedIn && inCompany" class="menu-item"><a href="/companyanalytics">{{ $t('company.reports') }}</a></li>
